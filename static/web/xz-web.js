    ...
    app.web = {
        ...
        weixinLogin(obj) {
            ...
            if (isWeixin) {
				...
				console.log(xzSystem.host+loginSrc);
                let complete = false,
                    dialog = app.web.dialogBox({
                        title: app.language.weixinScan,
                        content: '<div style="text-align:center" class="p20"><img src=/api/qrcode/?data=' + encodeURIComponent(xzSystem.host + loginSrc) + ' width="180" height="180" /></div>',
                        width: 320,
                        height: 300,
                        complete: function() {
                            complete = true;
